...
public class PlayerAnimation : MonoBehaviour
{
    ...
    public string[] idleDirections = { "IdleBack", "IdleBackLeft", "IdleLeft", "IdleFrontLeft", "IdleFront", "IdleFrontRight", "IdleRight", "IdleBackRight" };
    public string[] walkDirections = { "WalkBack", "WalkBackLeft", "WalkLeft", "WalkFrontLeft", "WalkFront", "WalkFrontRight", "WalkRight", "WalkBackRight" };
    public string[] attackDirections = { "AttackBack", "AttackBackLeft", "AttackLeft", "AttackFrontLeft", "AttackFront", "AttackFrontRight", "AttackRight", "AttackBackRight" };
    int lastDirection;
