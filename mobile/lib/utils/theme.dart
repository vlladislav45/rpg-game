...
class CustomTheme {
  static Color _lightPrimary = Color(HexColor.convertHexColor('#d61693')); // main color
  static Color _lightPrimaryVariantColor =
      Color(HexColor.convertHexColor('#d61693')); // Appbar color
  static Color _lightSecondaryColor = Color(HexColor.convertHexColor('#5df9d1'));
  ...
  static Color _lightAccentColor =
      Color(HexColor.convertHexColor('#fae950')); // Title texts
      ...
      headline1: TextStyle(
          ...
          shadows: [
            Shadow(
                ...
                color: Color(HexColor.convertHexColor('#d134a0'))),
            Shadow(
                // bottomRight
                offset: Offset(1.5, -1.5),
                color: Color(HexColor.convertHexColor('#d134a0'))),
